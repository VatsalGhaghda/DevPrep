...
/**
 * Build an ISO-date-keyed map from the activity array
 * and fill in every day of the last 365 days with a count (0 if missing).
 */
...
function ActivityHeatmap({ activity }) {
  ...
  // Chunk into weeks (53 columns of 7)
  const weeks = [];
